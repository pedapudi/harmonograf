...
class SessionUpdate(_message.Message):
    __slots__ = ("session", "agent", "initial_span", "initial_annotation", "burst_complete", "new_span", "updated_span", "ended_span", "new_annotation", "agent_joined", "agent_left", "agent_status_changed", "session_ended", "payload_available", "task_report", "context_window_sample", "goldfive_event", "invocation_cancelled")
